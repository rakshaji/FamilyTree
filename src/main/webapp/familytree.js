        ...
        if (i && i.hasAttribute) {
            ...
            switch (n) {
                ...
                case "share":
                    ...
                    break;
                case "remove":
                    r.obj.removeNode(e, null, !0), r.hide(), deleteMember(e),console.log("delete click" + e);
            }
        }
    }))
